...
// Dot grid columns
private const val DOT_COLUMNS = 11
private const val MIN_DOT_COLUMNS = 7
...
class Month3x2WidgetProvider : HomeWidgetProvider() {
  ...
  override fun onUpdate(
    ...
    appWidgetIds.forEach { widgetId ->
      val views = RemoteViews(context.packageName, R.layout.month_3x2_widget)
  ...
  override fun onReceive(context: Context, intent: android.content.Intent) {
    ...
    if (intent.action == android.content.Intent.ACTION_CONFIGURATION_CHANGED) {
      ...
      val ids = manager.getAppWidgetIds(android.content.ComponentName(context, Month3x2WidgetProvider::class.java))
