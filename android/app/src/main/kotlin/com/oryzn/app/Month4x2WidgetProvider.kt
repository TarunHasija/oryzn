...
// Dot grid columns
private const val DOT_COLUMNS = 13
private const val MIN_DOT_COLUMNS = 8

// Dot diameter in dp  ← change this to make dots bigger / smaller
private const val DOT_DIAMETER_DP = 15f
...
class Month4x2WidgetProvider : HomeWidgetProvider() {
  ...
  override fun onUpdate(
    ...
    appWidgetIds.forEach { widgetId ->
      val views = RemoteViews(context.packageName, R.layout.month_4x2_widget)
  ...
  override fun onReceive(context: Context, intent: android.content.Intent) {
    ...
    if (intent.action == android.content.Intent.ACTION_CONFIGURATION_CHANGED) {
      ...
      val ids = manager.getAppWidgetIds(android.content.ComponentName(context, Month4x2WidgetProvider::class.java))
