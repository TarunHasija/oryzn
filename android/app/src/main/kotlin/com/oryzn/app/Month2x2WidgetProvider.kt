...
// Dot grid columns
private const val DOT_COLUMNS = 8
private const val MIN_DOT_COLUMNS = 5
...
class Month2x2WidgetProvider : HomeWidgetProvider() {
  ...
  override fun onUpdate(
    ...
    appWidgetIds.forEach { widgetId ->
      val views = RemoteViews(context.packageName, R.layout.month_2x2_widget)
  ...
  override fun onReceive(context: Context, intent: android.content.Intent) {
    ...
    if (intent.action == android.content.Intent.ACTION_CONFIGURATION_CHANGED) {
      ...
      val ids = manager.getAppWidgetIds(android.content.ComponentName(context, Month2x2WidgetProvider::class.java))
